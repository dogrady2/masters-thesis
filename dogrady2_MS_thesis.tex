...
\begin{figure}[h]
\begin{tabular}{ccc}
\includegraphics[trim={0 2cm 0 3.1cm},clip,width=0.3\linewidth]{./Figures/lf_boc.pdf} & \includegraphics[trim={0 2cm 0 3.1cm},clip,width=0.3\linewidth]{./Figures/lf_boc.pdf} & \includegraphics[trim={0 2cm 0 3.1cm},clip,width=0.3\linewidth]{./Figures/lf_boc.pdf}\\
\end{tabular}
