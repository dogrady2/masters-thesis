...
%Third Paper
%%%%%%
One of the computational codes that attempts to incorporate this multiphysics approach is FALCON \cite{falcon_montgomery_1997}.
...
In order to demonstrate the accuracy of a \gls{CDI} based criteria, Lyon et al. simulated 14 fuel rods from the Studsvik Over Ramp, Super Ramp and Trans Ramp IV program, as well as, rods from a CEA/OSIRIS ramp program using FALCON \cite{experimental_killeen_2004}. 
...
To do so, the Studsvik ramp tests were implemented in BISON using a four step process \cite{experimental_killeen_2004}.
...
Fuel specifications limit the dimension of a \gls{MPS} to 60 mils, but widths up to 125 mils have been observed during \gls{PIE} \cite{effect_aleshin_2010}.
...
As described in \cite{capps_evaluation,kennard_pci}, fuel rod response to a change in power is a function of fuel rod's conditioning. 
