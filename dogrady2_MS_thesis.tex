...
\begin{figure}[h]
\begin{tabular}{c}
\includegraphics[trim={0 5cm 0 5cm},clip,width=\linewidth]{./Figures/bison_res/IPR_MCHS.pdf} \\
\includegraphics[trim={0 5cm 0 5cm},clip,width=\linewidth]{./Figures/bison_res/IPR_MGD.pdf} \\
\end{tabular}
