...
This geometric configuration has been shown to have consistent results with RZ simulations and is capable of reducing the computational time required for each power ramp. %need citation
