...
\degreeyear{2018}
\committee{Associate Professor Tomasz Kozlowski, Advisor \\Assistant Professor Kathryn Huff}
\maketitle
...
The beneficiary of this competition are the customers, who are guaranteed fair prices for electricity and will not be paying for inefficient/uneconomical utility project. %need citation
...
\textbf{Power Ramp} & \textbf{Time}         & \textbf{Power Level}         & \textbf{Hold Time}         & \textbf{Return to Full}     & \textbf{Pin Position} & \textbf{Hoop Stress}  \\
                    & \textbf{[hours]}      & \textbf{[\%]}                & \textbf{[hours]}           & \textbf{Power time [Hours]} &                       & \textbf{[MPa]} \\\hline
...
\multicolumn{6}{l}{* Contains intermediate power holds}\\\hline
\end{tabular}}
\end{center}
\end{table}
...
%Although the fuel pin with the maximum weighted change in linear heat rate did not exhibit the maximum cladding hoop stress. 
