...
\gls{PCMI} can lead to fuel failure by {PCI}, and has been extensively investigated since the early 1970s.
...
Since then, \gls{PCI} has been extensively studied in order to increase the efficiency of reactor operation and minimize the number of fuel failures.
...
In the presence of an aggressive local chemical environment, "\gls{PCI}-SCC", or a \gls{MPS}, "\gls{PCI}-\gls{MPS}", \gls{PCMI}
In the absence of fuel/cladding defects, it is the primary cause of fuel failure during standard operation of a \gls{PWR}. % Need Citation
\gls{PCI} is a result of fuel 

A $UO_2$ fuel pellets radius is a strong function of power, quantified using the pellet's \gls{lhr}, and exposure.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
