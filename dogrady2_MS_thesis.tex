...
\begin{figure}[h]
\begin{tabular}{c}
\includegraphics[trim={0 2cm 0 3.1cm},clip,width=0.85\linewidth]{./Figures/bison_res/IPR_MCHS.pdf} \\
\includegraphics[trim={0 2cm 0 3.1cm},clip,width=0.85\linewidth]{./Figures/bison_res/IPR_MGD.pdf} \\
\end{tabular}
