...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=\linewidth,trim={2cm 5cm 2cm 5cm}]{./Figures/VERA-CS-Figure.pdf}
\end{center}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[trim={0 2cm 0 2cm},clip,width=\linewidth]{./Figures/crw_diff.pdf}
\end{center}
...
%\begin{figure}[!htb]
%\begin{center}
%\includegraphics[trim={0 2cm 0 3.1cm},clip,width=\linewidth]{./Figures/as_is_b.pdf}
%\end{center}
%\caption{Comparison of simulated to the uncorrected measured critical boron concentrations.}
%\label{fig:as_is_b}
%\end{figure} 
\begin{figure}[!htb]
\begin{center}
\includegraphics[trim={0 2cm 0 3.1cm},clip,width=\linewidth]{./Figures/corr_b.pdf}
\end{center}
